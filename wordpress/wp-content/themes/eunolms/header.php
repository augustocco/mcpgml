...
$header_isotype_url = ! empty( $client_branding['isotype_url'] )
    ? $client_branding['isotype_url']
    : $client_branding['logo_url'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo esc_url( $header_isotype_url ?: 'https://eks12.lmseunoconsulting.com/wp-content/uploads/2026/03/iso-euno.png' ); ?>">
            ...
            <div class="euno-header-container">
                <div class="euno-logo">
                    <a href="<?php echo home_url( '/' ); ?>">
                        <img src="<?php echo esc_url( $header_isotype_url ); ?>" 
